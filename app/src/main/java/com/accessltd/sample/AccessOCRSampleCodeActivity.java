...
public class AccessOCRSampleCodeActivity extends Activity implements AccessDeviceStatusListener, AccessBarcodeDataListener, AccessMSRDataListener, AccessOCRDataListener {
    ...
    @Override
    public void AccessDeviceConnected(char DeviceType, String VendorId,
                                      String ProductId) {
    ...
    @Override
    public void AccessDataBarcodeRx(char BarcodeID, ByteBuffer dataReceived,
                                    int dataReceivedLen) {
    ...
    @Override
    public void AccessDataMSRRx(char CardType, ByteBuffer dataReceived,
                                int dataReceivedLen) {
    ...
    @Override
    public void AccessDataMSRTracksRx(char CardType,
                                      ByteBuffer[] dataReceivedTrack, int[] dataReceivedLen) {
    ...
    @Override
    public void AccessDataOCRLinesRx(ByteBuffer[] dataReceivedLine,
                                     int[] dataReceivedLen) {
